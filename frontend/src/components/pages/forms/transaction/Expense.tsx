...
import useExpenseTransaction from '../../../../features/transaction/hooks/useExpenseTransaction';
...
const Expense = () => {
  const {
    ...
    setError,
    formState: { errors },
  } = useForm<ExpenseDataType>({
    resolver: zodResolver(expenseSchema),
  });

  const { mutate, isPending } = useExpenseTransaction(setError);
  ...
  const expenseCategories: Category[] | undefined = categories?.filter(
    ...
    return (
      <main className="min-h-screen flex">
        <article className="bg-transparent flex-1 flex flex-col items-center justify-center">
          ...
          <p className="text-neutral-500 mb-8 tracking-wide text-center text-base font-medium">
            You need at least one account before you can record an expense.{' '}
            <br />
    ...
    return (
      <main className="min-h-screen flex">
        <article className="bg-transparent flex-1 flex flex-col items-center justify-center">
          ...
          <p className="text-neutral-500 mb-8 tracking-wide text-center text-base font-medium">
            You need at least one category before you can record an expense.{' '}
            <br />
            Please create them first and try again.
          </p>
          <div className="flex items-center gap-5">
